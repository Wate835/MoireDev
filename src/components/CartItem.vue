<template>
  <li class="cart__item product">
    <div class="product__pic">
      <img
        :src="img !== null ? img : 'assets/no-image.jpg'"
        width="120"
        height="120"
        :alt="title"
      />
    ...
    <base-item-counter
      ...
      :itemAmount="amount"
      @change-item-amount="setItemAmount"
    ></base-item-counter>

    <b class="product__price"> {{ price * productAmount }} ₽ </b>

    <div class="product__status">
      <span class="product__error" v-if="isSendingFailed"
